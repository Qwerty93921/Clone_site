...
from .views import (home, base_page_viewer, food_viewer, drinks_viewer, login_page_viewer, register_page_viewer,
                    auth_views,
                    about_viewer, user_profile_viewer, logout_viewer)
